...
public class ClientGreeter {
	...
	public static void main(String[] args) {
		...
		String ipAddress =  "192.168.7.223";
		...
		try {
			...
			Socket s = new Socket(ipAddress, portNumb);
			...
			DataInputStream inpStm = new DataInputStream(s.getInputStream());
